...
class SubscriptionRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'subscription_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\web_subscription\Entity\SubscriptionInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\web_subscription\Entity\SubscriptionInterface
